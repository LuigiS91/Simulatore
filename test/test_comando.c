...
//    t_res_routh stabilita;
    ...
    u_com.rampa_scontr.t_3=6;
    u_com.rampa_scontr.t_4=6;
    u_com.rampa_scontr.t_finale=6;
    u_com.rampa_scontr.ampiezza_iniziale=0;
    u_com.rampa_scontr.ampiezza_1=1;
    u_com.rampa_scontr.ampiezza_intermedia=0;
    u_com.rampa_scontr.ampiezza_2=0;
    u_com.rampa_scontr.ampiezza_finale=0;
...
*/
    ...
    u_com.trap_scontr.tipo=trapezio_scontrato;
    u_com.trap_scontr.t_inizio=20;
    u_com.trap_scontr.Dt_rampa=1;
    u_com.trap_scontr.ampiezza_iniziale=res_trim.comando.da;
    u_com.trap_scontr.ampiezza_regime=res_trim.comando.da+1*DEG_TO_RAD;
    u_com.trap_scontr.Dt_regime=3;
    u_com.trap_scontr.Dt_ritardo=50;


    set_comando(u_com,c_da);
    u_com.trap_scontr.ampiezza_regime=res_trim.comando.da+0.5*DEG_TO_RAD;
    set_comando(u_com,c_dr);

    u_com.rampa_scontr.tipo=trapezio;
    u_com.rampa_scontr.t_inizio=20;
    u_com.rampa_scontr.t_1=21;
    u_com.rampa_scontr.t_2=21;
    u_com.rampa_scontr.t_3=21;
    u_com.rampa_scontr.t_4=79;
    u_com.rampa_scontr.t_finale=80;
    u_com.rampa_scontr.ampiezza_iniziale=res_trim.comando.de;
    u_com.rampa_scontr.ampiezza_1=res_trim.comando.de-1*DEG_TO_RAD;
    u_com.rampa_scontr.ampiezza_intermedia=res_trim.comando.de-1*DEG_TO_RAD;
...
/*
    u_com.rampa.tipo=rampa;
    u_com.rampa.ampiezza_iniziale=res_trim.comando.de;
    u_com.rampa.ampiezza_finale=res_trim.comando.de-1*DEG_TO_RAD;
    u_com.rampa.t_inizio=30;
    u_com.rampa.t_fine=200;
